...
const Cards = (props) => {
    return (
        <Card className='my-10 mx-auto md:my-4 xl:mx-1 max-w-[325px] min-h-[450px] border-2 border-gray-600 hover:shadow-xl hover:shadow-yellow-600'>
            <CardMedia
                className='h-[60%] border-b-2 border-gray-400'
                image={props.img}
                title={props.art}
            />
            <CardContent>
