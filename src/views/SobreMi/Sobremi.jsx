        ...
        <div id='sobremi'>
            ...
            <div className='w-full md:w-[60%] md:mx-auto md:p-6 md:flex md:flex-col md:justify-center'>
                <p className='font-poppins md:text-[18px] md:my-2 text-justify mx-4 md:text-center'>
                    ...
                    obtuve la certificacion de <a href='https://www.coderhouse.com/certificados/62d6f7994c0b1000199117a3' target='_blank' without rel="noreferrer" className='cursor-pointer hover:text-yellow-800 font-roboto text-gray-600'>"Desarrollador Frontend React.js"</a>
                </p>
                <p className='font-poppins md:text-[18px] md:my-2 text-justify mx-4 md:text-center'>
                    En la misma, para lograr dicha certificacion, realize la carrera de: <a href='https://www.coderhouse.com/certificados/62337d24cdfb9a0019c7aaa6' target='_blank' without rel="noreferrer" className='cursor-pointer hover:text-yellow-800 font-roboto text-gray-600'>"Desarrollador Web"</a> || <a href='https://www.coderhouse.com/certificados/62660f4682d72600243abcd6' target='_blank' without rel="noreferrer" className='cursor-pointer hover:text-yellow-800 font-roboto text-gray-600'>"JavaScript"</a> || <a href='https://www.coderhouse.com/certificados/62d5ad2542d67d0019c57167' target='_blank' without rel="noreferrer" className='cursor-pointer hover:text-yellow-800 font-roboto text-gray-600'>"React.js"</a>. Logrando con estos la certificacion antes mencionada.
